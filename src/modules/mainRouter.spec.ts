...
const MenuTPL = () => 'menu';
const TEMPLATE1 = () => 'first';
const TEMPLATE2 = () => 'second';
const NOTFOUND = () => '404';
...
function Menu() {
  return new TestComponent('div', {}, 'test', MenuTPL);
}
Menu();
function firstPage() {
  return new TestComponent('div', {}, 'first', TEMPLATE1);
}
function secondPage() {
  return new TestComponent('div', {}, 'second', TEMPLATE2);
}
function notFoudPage() {
  return new TestComponent('div', {}, 'not', NOTFOUND);
}
